                    ...
                    {images.map((img, index) => (
                        ...
                        >
                            <img
                                src={img.src}
                                alt={img.alt}
                                className={`w-full object-cover ${img.position || 'object-center'} transition-transform duration-700 group-hover:scale-110 ${index === 0 ? 'h-60 md:h-full md:min-h-[500px]' : 'h-60 md:h-64'
                                    }`}
                            />
